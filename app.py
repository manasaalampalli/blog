...
mydb=mysql.connector.connect(host='localhost',user='root',password='manasa',db='manu')
with mysql.connector.connect(host='localhost',user='root',password='manasa',db='manu'):
